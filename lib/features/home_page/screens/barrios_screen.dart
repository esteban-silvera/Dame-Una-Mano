                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color(0xff1f1f1f1), // Color de fondo del contenedor
                      borderRadius:
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              border:
                                  Border.all(color: const Color(0xFF43c7ff)),
                        ...
                        Padding(
                          padding:
                              const EdgeInsets.all(0.0), // Espacio a la derecha
                          child: ElevatedButton(
                            onPressed: () {
                              if (selectedBarrio == null) {
                                ...
                                List<Trabajador> trabajadoresEnBarrio =
                                    trabajadores
                                        .where((trabajador) =>
                                ...
                                if (trabajadoresEnBarrio.isNotEmpty) {
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        title:
                                            const Text('Trabajadores cercanos'),
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                        onPressed:
                            _getLocation, // Ejecutar la función _getLocation
                        child: const Text(
                          'Cambiar a ubicación actual',
                          style: TextStyle(
                            fontSize: 16,
                            color: Color.fromARGB(
                                255, 16, 16, 16), // Color del texto
